...
function RecruiterLogin() {
  ...
  const handleLogin = (e) => {
    ...
    // For now, directly go to recruiter dashboard
      ...
      <div style={styles.container}>
        ...
        <div style={styles.leftSection}>
          ...
          <p style={styles.description}>
            Sign in to your recruiter account and manage your
            recruitment process with intelligent AI-powered tools.
          </p>
          ...
          <div style={styles.features}>
            ...
            <div style={styles.feature}>
              ...
              <div>
                ...
                <span style={styles.featureText}>
                  Track and improve your hiring process
                </span>
              </div>
            </div>
