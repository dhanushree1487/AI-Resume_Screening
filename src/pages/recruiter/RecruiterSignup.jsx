      ...
      <div style={styles.container}>
        ...
        <div style={styles.leftSection}>
          ...
          <p style={styles.description}>
            Create your recruiter account and discover smarter
            ways to find, evaluate, and hire the best candidates.
          </p>
          ...
          <div style={styles.features}>
            ...
            <div style={styles.feature}>
              ...
              <div>
                ...
                <span style={styles.featureText}>
                  Automatically identify relevant candidates
                </span>
              </div>
            ...
            <div style={styles.feature}>
              ...
              <div>
                ...
                <span style={styles.featureText}>
                  Make better hiring decisions with insights
                </span>
              </div>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>
            Join RECRUVA AI and start hiring smarter
          </p>
